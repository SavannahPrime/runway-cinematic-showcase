...
const ModelSpotlight: React.FC = () => {
  ...
  return (
    <section 
      ref={spotlightRef} 
      className="relative bg-[#1A1F3A] py-24 overflow-hidden text-white"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 my-8">
              <div className="transition-all duration-300 hover:translate-y-[-5px]">
                <p className="text-sm text-white/60 uppercase tracking-wider">Height</p>
                <p className="text-lg">5'11" / 180cm</p>
              </div>
              <div className="transition-all duration-300 hover:translate-y-[-5px]">
                <p className="text-sm text-white/60 uppercase tracking-wider">Hair</p>
                <p className="text-lg">Blonde</p>
              </div>
              <div className="transition-all duration-300 hover:translate-y-[-5px]">
                <p className="text-sm text-white/60 uppercase tracking-wider">Eyes</p>
                <p className="text-lg">Blue</p>
              </div>
              <div className="transition-all duration-300 hover:translate-y-[-5px]">
                <p className="text-sm text-white/60 uppercase tracking-wider">Based in</p>
            ...
            <div className="pt-4">
              <Link to="/about" className="luxury-button bg-gold text-[#1A1F3A] hover:bg-white group">
          ...
          >
            ...
            <img
              ...
              loading="eager"
            />
            <div className="absolute -bottom-6 -right-6 bg-white p-6 shadow-lg transform hover:translate-y-[-5px] transition-transform duration-300 text-[#1A1F3A]">
